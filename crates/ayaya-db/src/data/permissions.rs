...
impl Permissions {
    ...
    pub async fn find_user_allowed(
        ...
        user_id: u64,
        command: &str,
    ) -> DataResult<Option<crate::entity::command_allow_user::Model>> {
        ...
        use crate::entity::command_allow_user;
    ...
    pub async fn find_command_roles_allowed(
        ...
        guild_id: u64,
        command: &str,
    ) -> DataResult<Vec<crate::entity::require_command_role::Model>> {
        ...
        use crate::entity::require_command_role;
        self.metrics_handler
            .data_access(OP, DataOperationType::Read)
            .await;
    ...
    pub async fn find_category_roles_allowed(
    ...
    ) -> DataResult<Vec<crate::entity::require_category_role::Model>> {
        ...
        use crate::entity::require_category_role;
        self.metrics_handler
            .data_access(OP, DataOperationType::Read)
            .await;
    ...
    pub async fn new_command_role_restriction(
        ...
        command: &str,
    ) -> DataResult<crate::entity::require_command_role::Model> {
    ...
    pub async fn new_category_role_restriction(
        ...
        role_id: &serenity::RoleId,
        command_category: &str,
    ) -> DataResult<crate::entity::require_category_role::Model> {
    ...
    pub async fn new_command_user_allowed(
        ...
        user_id: u64,
        command: &str,
    ) -> DataResult<crate::entity::command_allow_user::Model> {
    ...
    pub async fn findall_user_allowed(
        ...
        guild_id: u64,
        command: &str,
    ) -> DataResult<Vec<crate::entity::command_allow_user::Model>> {
...
impl Permissions {
    pub async fn setup_cache_metrics(
        metrics_handler: Arc<dyn MetricsSink>,
...
mod tests {
    ...
    async fn get_manager() -> Permissions {
        ...
        Permissions::new(db, Arc::new(NoopMetrics)).await.unwrap()
    }
