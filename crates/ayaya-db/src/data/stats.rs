...
use ayaya_core::metrics::MetricsSink;
...
impl StatsManager {
    ...
    pub fn new(stats_db: DatabaseConnection, metrics_handler: Arc<dyn MetricsSink>) -> Self {
        Self {
            stats_db,
            metrics_handler,
        }
    ...
    pub async fn add_song_queue_count(
        ...
        self.metrics_handler
            .data_access(OP, ayaya_core::metrics::DataOperationType::Write)
            .await;
        let _timing = DataTiming::new(
            OP.to_string(),
            ayaya_core::metrics::DataOperationType::Write,
            Some(self.metrics_handler.clone()),
        );

        use crate::entity::song_queues;
...
impl StatsManager {
    pub async fn add_user_play_query(
        ...
        use crate::entity::user_play_queries;
    ...
    pub async fn get_user_play_queries(
        ...
        guild_id: u64,
        user: &serenity::User,
    ) -> DataResult<Vec<crate::entity::user_play_queries::Model>> {
