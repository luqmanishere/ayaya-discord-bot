...
function _layout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (store_get($$store_subs ??= {}, "$auth", auth).isLoading) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="loading-container svelte-12qhfyh"><div class="spinner svelte-12qhfyh"></div> <p class="svelte-12qhfyh">Loading...</p></div>`);
    } else {
      $$renderer2.push("<!--[!-->");
      children($$renderer2);
      $$renderer2.push(`<!---->`);
