...
- Code style
- Implement voice stats command

## [2026.4.21-0] - 2026-04-21

### Added

- Add new clear command
...
- Scaffold akend pulls summary UI and migrate seq_id to integer
- Refactor tracker to multifile

### Fixed

- Using temp fork for DAVE enc support

## [2026.2.20-0] - 2026-02-20

### Changed

- Implement support for weapon pulls

## [2026.2.11-1] - 2026-02-11

### Changed

- Factor out dashboard into its own thing

## [2026.2.11-0] - 2026-02-11

### Added

- Add support for importing akend pulls

### Changed

- Basic (incorrect) pull stats
- Switch away from deprecated actions
- Migrate tracker interface to componentsv2
- Migrate to serenity-next

### Fixed

- Fix clippy and formatting errors

## [2026.2.1-2] - 2026-02-01
...
- Migration crate should use workspace version
...
- Initial dashboard impl with auth
...
[2026.4.22-0]: https://github.com///compare/v2026.4.21-0..v2026.4.22-0
[2026.4.21-0]: https://github.com///compare/v2026.4.14-1..v2026.4.21-0
[2026.4.14-1]: https://github.com///compare/v2026.4.14-0..v2026.4.14-1
...
[2026.2.11-0]: https://github.com///compare/v2026.2.1-2..v2026.2.11-0
[2026.2.1-2]: https://github.com///compare/v2026.2.1-1..v2026.2.1-2
